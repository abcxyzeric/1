...
export async function translateText(
  ...
  presets: TranslationPreset[] = [], // Changed to accept array of presets
  previousHistory: { input: string; output: string }[] = [] // Add history param
  ...
  // If no presets provided, use a default fallback internally or let promptBuilder handle empty strings.
  // We pass whatever is provided to buildSystemInstruction.
