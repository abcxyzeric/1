    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="flex-grow p-6 overflow-y-auto space-y-6 text-gray-300">
          ...
          <div>
            <h3 className="mb-3 text-lg font-semibold text-gray-200">DANH SÁCH KHÓA API GEMINI CỦA BẠBạn</h3>
          ...
          <div>
            ...
            >
              <option value="gemini-3-pro-preview" className="bg-gray-800 text-gray-200">Gemini 3 Pro Preview (Thông minh nhất, Mặc định)</option>
              <option value="gemini-2.5-pro" className="bg-gray-800 text-gray-200">Gemini 2.5 Pro (Chất lượng cao)</option>
              <option value="gemini-2.5-flash" className="bg-gray-800 text-gray-200">Gemini 2.5 Flash (Nhanh)</option>
            </select>
          </div>
        </div>
